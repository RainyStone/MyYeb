<template>
  <div>
    <div style="display: flex;margin-right: 10%;justify-content: center">
      <el-input @keydown.enter.native="doSearch" v-model="keywords" style="width: 30%;margin-right: 10px"
        place-holder="通过用户名搜索用户..." prefix-icon="el-icon-search"></el-input>
    ...
    <div class="admin-container">
      <el-card class="admin-card" v-for="(admin, index) in admins" :key="index">
        <div slot="header" class="clearfix">
          ...
          <el-button style="float: right;font-size: 15px; color:red;padding: 3px 0" type="text" icon="el-icon-delete"
        ...
        <div>
          ...
          <div class="userInfo-container">
            ...
            <div>
              用户状态：
              <el-switch v-model="admin.enabled" @change="enabledChange(admin)" active-color="#13ce66"
            ...
            <div>
              ...
              <el-popover @show="showPop(admin)" @hide="hidePop(admin)" placement="right" title="角色" width="200"
                trigger="click">
