<template>
  <div>
    ...
    <div>
      <el-input v-model="jl.name" placeholder="添加职称等级..." perfix-icon="el-icon-plus" style="width: 300px"
        size="small"></el-input>
      ...
      <el-button style="margin-left: 8px" type="primary" size="small" icon="el-icon-plus"
        @click="addJobLevel">添加</el-button>
    </div>

    <div style="margin-top: 10px">
      <el-table border :data="jls" stripe size="small" style="width: 70%" @selection-change="handleSelectionChange">
      ...
      <el-button style="margin-top: 10px" :disabled="this.multipleSelection.length == 0" size="small" type="danger"
    ...
    <el-dialog title="编辑职称" :visible.sync="dialogVisible" width="30%">
      <table>
        <tr>
          ...
          <td><el-input style="margin-left: 8px;width:300px" v-model="updateJl.name" placeholder="请输入..."
        ...
        <tr>
          ...
          <td><el-switch style="margin-left: 8px" v-model="updateJl.enabled" active-text="已启用" inactive-text="未启用">
            </el-switch></td>
        </tr>
      </table>
